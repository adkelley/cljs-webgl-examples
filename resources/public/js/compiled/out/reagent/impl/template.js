...
var G__26621 = o;
(G__26621[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__26622__delegate = function (args){
...
return G__26622__delegate.call(this,args);};
G__26622.cljs$lang$maxFixedArity = 0;
G__26622.cljs$lang$applyTo = (function (arglist__26624){
var args = cljs.core.seq(arglist__26624);
return G__26622__delegate(args);
});
...
var G__26630 = jsprops;
(G__26630["defaultValue"] = value);

(G__26630["onChange"] = ((function (G__26630,v,value,on_change){
return (function (p1__26627_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__26627_SHARP_);
});})(G__26630,v,value,on_change))
);

(G__26630["ref"] = ((function (G__26630,v,value,on_change){
return (function (p1__26628_SHARP_){
return (this$["cljsInputElement"] = p1__26628_SHARP_);
});})(G__26630,v,value,on_change))
);
...
var vec__26637 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__26637,(0),null);
var id = cljs.core.nth.call(null,vec__26637,(1),null);
var class$ = cljs.core.nth.call(null,vec__26637,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___26642 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___26642 == null)){
} else {
var key_26643 = temp__4661__auto___26642;
(jsprops["key"] = key_26643);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__26645 = (new reagent.impl.template.NativeWrapper());
(G__26645["name"] = c);
...
var len__25996__auto___26651 = arguments.length;
var i__25997__auto___26652 = (0);
while(true){
if((i__25997__auto___26652 < len__25996__auto___26651)){
args__26003__auto__.push((arguments[i__25997__auto___26652]));

var G__26653 = (i__25997__auto___26652 + (1));
i__25997__auto___26652 = G__26653;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__26650,seq26649__$1);
});
...
break;
default:
var G__26657 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__26657;
continue;
...
var n__25806__auto___26660 = a.length;
var i_26661 = (0);
while(true){
if((i_26661 < n__25806__auto___26660)){
(a[i_26661] = reagent.impl.template.as_element.call(null,(a[i_26661])));

var G__26662 = (i_26661 + (1));
i_26661 = G__26662;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__25806__auto___26663 = a.length;
var i_26664 = (0);
while(true){
if((i_26664 < n__25806__auto___26663)){
var val_26665 = (a[i_26664]);
if((cljs.core.vector_QMARK_.call(null,val_26665)) && ((reagent.impl.template.key_from_vec.call(null,val_26665) == null))){
(o["no-key"] = true);
} else {
}

(a[i_26664] = reagent.impl.template.as_element.call(null,val_26665));

var G__26666 = (i_26664 + (1));
i_26664 = G__26666;
continue;
} else {
}
...
var ctx = ({});
var vec__26670 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__26670,(0),null);
var derefed = cljs.core.nth.call(null,vec__26670,(1),null);
...
var G__26674 = (cljs.core.count.call(null,argv) - first_child);
switch (G__26674) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__26674){
...
//# sourceMappingURL=template.js.map?rel=1480258608490