...
args__7658__auto__.push((arguments[i__7652__auto___9576]));
...
triangle.core.log.cljs$lang$applyTo = (function (seq9574){
return triangle.core.log.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq9574));
});
...
var triangle_vertex_buffer = cljs_webgl.buffers.create_buffer.cljs$core$IFn$_invoke$arity$variadic(gl,geometry.basic_shapes.triangle,cljs_webgl.constants.buffer_object.array_buffer,cljs_webgl.constants.buffer_object.static_draw,cljs.core.array_seq([(3)], 0));
